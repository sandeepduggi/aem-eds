...
async function createTableHeader(table){
    ...
    tr.append(sno);tr.append(conuntry);tr.append(capitalh);tr.append(continenth);
    table.append(tr);
}
async function createTableRow(table,row,i){
    ...
    tr.append(sno);tr.append(conuntry);tr.append(continent);tr.append(capital);
    table.append(tr);
}
...
async function createTable(jsonURL,val) {
    ...
    json.defalt.data.forEach((row,i) => {
